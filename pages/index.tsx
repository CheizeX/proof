...
const Home: NextPage = () => {
  return (
    <div className="flex justify-center items-start h-full ">
      ...
      <main className="container flex justify-start items-center w-[430px] flex-col h-[926px] border">
        <Navbar />
        ...
        <section className="container flex justify-start items-center h-[926px] " />
        <footer className="container flex justify-around items-center h-[60px] shadow-[0_-2px_3px_#B7B7B74D]">
          <button
            type="button"
